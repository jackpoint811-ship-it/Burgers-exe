...
12. Si la fase ejecuta o reintenta lanzamiento productivo, leer `docs/codex-memory/20-production-launch-readiness.md`.
13. Leer esta memoria base:
   - `01-estado-actual.md`
   - `02-reglas-del-proyecto.md`
   - `07-decisiones.md`
14. Leer workflow y checklists:
   - `08-agent-workflow.md`
   - `09-checklists.md`
15. Leer el archivo especifico segun el area:
...
16. Usar Graphify antes de cambios grandes, de arquitectura o de varios archivos, si esta disponible.
17. Terminar cambios en rama, commit, push y PR cuando el usuario apruebe el cierre o cuando el prompt lo pida explicitamente.
