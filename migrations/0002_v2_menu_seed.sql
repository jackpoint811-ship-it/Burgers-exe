...
INSERT OR REPLACE INTO menu_items (id, sku, category_key, name, description, price_cents, tags_json, badge, promo_label, is_available, is_featured, sort_order, image_url, image_key, combo_links_json, upsell_items_json, updated_at) VALUES
  ('i1', 'BRG-OG', 'burgers', 'Burger OG', 'Doble carne, queso y salsa de la casa.', 14900, '["signature"]', 'Best Seller', 'Hot', 1, 1, 1, '/placeholders/burger-og.jpg', 'menu/burger-og.jpg', '["PROMO-COMBO-OG"]', '["EXT-BACON"]', CURRENT_TIMESTAMP),
  ('i2', 'BRG-SPICY', 'burgers', 'Burger Spicy', 'Chile crunch y mayo picante.', 15900, '["spicy"]', NULL, NULL, 1, 1, 2, '/placeholders/burger-spicy.jpg', 'menu/burger-spicy.jpg', '["PROMO-SPICY-NIGHT"]', '["EXT-DIP"]', CURRENT_TIMESTAMP),
  ('i3', 'EXT-BACON', 'extras', 'Extra Bacon', 'Tiras crocantes.', 2900, '["addon"]', NULL, NULL, 1, 0, 10, '/placeholders/extra-bacon.jpg', 'menu/extra-bacon.jpg', '[]', '[]', CURRENT_TIMESTAMP),
  ('i4', 'DRK-COLA', 'drinks', 'Cola Pixel', 'Refresco helado 355ml.', 3900, '["drink"]', NULL, NULL, 0, 0, 15, '/placeholders/cola.jpg', 'menu/cola.jpg', '[]', '[]', CURRENT_TIMESTAMP),
  ('i5', 'GUA-FRIES', 'guarniciones', 'Fries OG', 'Papas doradas con sal especial.', 5900, '["side"]', NULL, NULL, 1, 1, 20, '/placeholders/fries.jpg', 'menu/fries.jpg', '["PROMO-COMBO-OG"]', '["EXT-DIP"]', CURRENT_TIMESTAMP);
